...
class Close extends \Mediaspa\Ticketing\Controller\Adminhtml\Ticket
{
    ...
    public function execute()
    {
        ...
        if ($ticket && $ticket->getId()) {
            try {
                $ticket->setStatus(\Mediaspa\Ticketing\Model\Ticket::STATUS_CLOSED);
                $ticket->save();
                ...
                $transport = $this->transportBuilder
                    ->setTemplateIdentifier($this->scopeConfig->getValue('mediaspa_ticketing/email_template/customer', $storeScope))
                    ->setTemplateOptions(
                        [
