...
class Save extends \Mediaspa\Ticketing\Controller\Ticket {
    ...
    public function execute() {
        ...
        try {
            ...
            $ticket->setStatus(\Mediaspa\Ticketing\Model\Ticket::STATUS_OPENED);
            $ticket->save();
            ...
            $transport = $this->transportBuilder
                    ->setTemplateIdentifier($this->scopeConfig->
                            getValue('mediaspa_ticketing/email_template/store_owner', $storeScope))
                    ->setTemplateOptions(
                            [
